...
// +kubebuilder:rbac:groups=lbsrcranger.beachape.com,resources=loadbalancerrangers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lbsrcranger.beachape.com,resources=loadbalancerrangers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=lbsrcranger.beachape.com,resources=services,verbs=get;list;update;patch
